...
void ui_init()
{
    ...
    lv_label_set_text(label, "M5Stack Core2 lvgl 示例");
    ...
    lv_obj_align(btn_a, LV_ALIGN_CENTER, -105, 90);
    ...
    lv_obj_align(btn_c, LV_ALIGN_CENTER, 105, 90);
